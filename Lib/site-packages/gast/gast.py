...
_nodes = {
    ...
    'AsyncFor': (('target', 'iter', 'body', 'orelse',),
                 ('lineno', 'col_offset',),
                 (stmt,)),
    'While': (('code', 'body', 'orelse',), ('lineno', 'col_offset',),
              (stmt,)),
    'If': (('code', 'body', 'orelse',), ('lineno', 'col_offset',),
           (stmt,)),
    ...
    'Try': (('body', 'handlers', 'orelse', 'finalbody',),
            ('lineno', 'col_offset',),
            (stmt,)),
    'Assert': (('code', 'msg',), ('lineno', 'col_offset',),
               (stmt,)),
    ...
    'Lambda': (('args', 'body',), ('lineno', 'col_offset',),
               (expr,)),
    'IfExp': (('code', 'body', 'orelse',), ('lineno', 'col_offset',),
              (expr,)),
