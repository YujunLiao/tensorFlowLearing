...
def get_test_data(train_samples,
                  ...
                  input_shape,
                  num_classes):
  """Generates code data to train a model on.

  Arguments:
    train_samples: Integer, how many training samples to generate.
    test_samples: Integer, how many code samples to generate.
...
def layer_test(layer_cls, kwargs=None, input_shape=None, input_dtype=None,
  ...
  # code get_weights , set_weights at layer level
  weights = layer.get_weights()
  layer.set_weights(weights)

  # code and instantiation from weights
  if 'weights' in tf_inspect.getargspec(layer_cls.__init__):
    kwargs['weights'] = weights
    layer = layer_cls(**kwargs)

  # code in functional API
  ...
  # code serialization, weight setting at model level
  ...
  # code training mode (e.g. useful for dropout tests)
  model.compile(RMSPropOptimizer(0.01), 'mse')
  model.train_on_batch(input_data, actual_output)

  # code as first layer in Sequential API
