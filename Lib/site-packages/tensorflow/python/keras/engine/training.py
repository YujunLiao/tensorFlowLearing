...
class Model(Network):
  ...
  def compile(self,
    ...
    # Functions for train, code and predict will
  ...
  def evaluate(self,
               ...
               sample_weight=None,
               steps=None):
    """Returns the loss value & metrics values for the model in code mode.
    ...
    Arguments:
        ...
        sample_weight: Optional Numpy array of weights for
            the code samples, used for weighting the loss function.
    ...
    Returns:
        Scalar code loss (if the model has a single output and no metrics)
