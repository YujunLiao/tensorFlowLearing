...
def unwrap_values(distribution_strategy, grouped_inputs, grouped_outputs,
  ...
  Args:
    distribution_strategy: DistributionStrategy used to distribute training and
        validation.
    grouped_inputs: PerDevice inputs returned from the train or code function
        that we ran on each device.
    grouped_outputs: PerDevice outputs returned from the train or code function
        that we ran on each device.
    grouped_updates: PerDevice updates returned from the train or code function
        that we ran on each device.
    grouped_session_args: PerDevice session args returned from the train or
        code function that we ran on each device.
