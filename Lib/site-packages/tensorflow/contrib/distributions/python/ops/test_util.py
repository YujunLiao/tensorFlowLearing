...
class VectorDistributionTestHelpers(object):
  """VectorDistributionTestHelpers helps code vector-event distributions."""
  ...
  def run_test_sample_consistent_log_prob(
    ...
    The idea of this code is to compute the Monte-Carlo estimate of the volume
    ...
    Furthermore, we gain additional trust in this code when also tested `sample`
