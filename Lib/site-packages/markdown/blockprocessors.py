...
class BlockProcessor(object):
    ...
    tree. Each processor will need to define it's own ``code`` and ``run``
    methods. The ``code`` method should return True or False, to indicate
    whether the current block should be processed by this processor. If the
    code passes, the parser will call the processors ``run`` method.
    ...
    def test(self, parent, block):
        ...
        As the parser loops through processors, it will call the ``code``
        ...
        etree element is also provided and may be used as part of the code.
