...
def _run_wsgi_app(*args):
    """This function replaces itself to ensure that the code module is not
...
class BaseRequest(object):
    ...
    def from_values(cls, *args, **kwargs):
        ...
        :class:`~werkzeug.code.EnvironBuilder`.

        .. versionchanged:: 0.5
           This method now accepts the same arguments as
           :class:`~werkzeug.code.EnvironBuilder`.  Because of this the
