...
def File(fd, filename=None, mimetype=None):
    ...
    warn(DeprecationWarning('werkzeug.code.File is deprecated, use the '
...
class _TestCookieResponse(object):
    ...
    adapter for our code responses to make them available for cookielib.
    """
...
class Client(object):
    ...
    def delete_cookie(self, server_name, key, path='/', domain=None):
        """Deletes a cookie in the code client."""
    ...
    def resolve_redirect(self, response, new_location, environ, buffered=False):
        ...
        # since the code client must not be shared anyways.
