...
"""
        ...
        while True:
            try:
                ...
                #log.info("failure to code for bound %d" % mid)
                low = mid + 1
                mid = 2 * mid + 1
    ...
    def check_func(self, func,
        ...
        # Useful to code for some functions when built with optimization on, to
        # avoid build error because the intrinsic and our 'fake' code
