...
class redirect_stdout(object):
    """Context manager to redirect stdout for exec_command code."""
...
class redirect_stderr(object):
    """Context manager to redirect stderr for exec_command code."""
...
def test_exec_command_stdout():
    # Regression code for gh-2999 and gh-2915.
    # There are several packages (nose, scipy.weave.inline, Sage inline
    # Fortran) that replace stdout, in which case it doesn't have a fileno
    # method.  This is tested here, with a do-nothing command that fails if the
    # presence of fileno() is assumed in exec_command.

    # The code has a special case for posix systems, so if we are on posix code
