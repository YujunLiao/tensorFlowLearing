...
class TestRemainder(object):
    ...
    def test_float_remainder_exact(self):
        # code that float results are exact for small integers. This also
...
class TestLogAddExp2(_FilterInvalids):
    # Need code for intermediate precisions
...
class TestMinMax(object):
    def test_minmax_blocked(self):
        # simd tests on max/min, code all alignments, slow but important
...
class TestAbsoluteNegative(object):
    def test_abs_neg_blocked(self):
        # simd tests on abs, code all alignments for vz + 2 * (vs - 1) + 1
...
class TestSpecialMethods(object):
    ...
    def test_wrap_and_prepare_out(self):
        ...
        class StoreArrayPrepareWrap(np.ndarray):
            ...
            def __repr__(self):
                return "a"  # for short code output
...
class TestRationalFunctions(object):
    ...
    def _test_lcm_inner(self, dtype):
        ...
        # broadcasting, and a code including 0
...
def test_reduceat():
    ...
    # code buffered -- this should work
