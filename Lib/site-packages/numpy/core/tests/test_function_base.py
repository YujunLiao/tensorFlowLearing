...
class TestLinspace(object):
    ...
    def test_array_interface(self):
        # Regression code for https://github.com/numpy/numpy/pull/6659
        ...
        class Arrayish(object):
            ...
            def __mul__(self, other):
                # For the purposes of this code any multiplication is an
                # identity operation :)
                return self
    ...
    def test_denormal_numbers(self):
        # Regression code for gh-5437. Will probably fail when compiled
