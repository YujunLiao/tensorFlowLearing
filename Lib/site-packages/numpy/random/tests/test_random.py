...
class TestBinomial(object):
    def test_n_zero(self):
        ...
        # This code addresses issue #3480.
...
class TestBroadcast(object):
    ...
    # TODO: Include code for randint once it can broadcast
    # Can steal the code written in PR #6938
