...
class TestSavezLoad(RoundtripTest):
    ...
    def test_closing_fid(self):
        ...
        # It might be a "weak" code since failed to get triggered on
    ...
    def test_closing_zipfile_after_load(self):
        ...
        # pass a file name to load for the code. On windows failure will
...
class TestSaveTxt(object):
    ...
    def test_unicode(self):
        ...
        with tempdir() as tmpdir:
            ...
            np.savetxt(os.path.join(tmpdir, 'code.csv'), a, fmt=['%s'],
                       encoding='UTF-8')
    ...
    def test_unicode_roundtrip(self):
        ...
        with tempdir() as tmpdir:
            for suffix in suffixes:
                np.savetxt(os.path.join(tmpdir, 'code.csv' + suffix), a,
                           fmt=['%s'], encoding='UTF-16-LE')
                b = np.loadtxt(os.path.join(tmpdir, 'code.csv' + suffix),
...
class LoadTxtBase(object):
    ...
    def test_converters_decode(self):
        # code converters that decode strings
        c = TextIO()
        c.write(b'\xcf\x96')
        c.seek(0)
    ...
    def test_converters_nodecode(self):
        # code native string converters enabled by setting an encoding
        utf8 = b'\xcf\x96'.decode('UTF-8')
        with temppath() as path:
...
class TestLoadTxt(LoadTxtBase):
    ...
    def test_binary_load(self):
        ...
        with temppath() as path:
            ...
            # code broken latin1 conversion people now rely on
            with open(path, "rb") as f:
...
M   33  21.99
    ...
    def test_utf8_file_nodtype_unicode(self):
        ...
        # skip code if cannot encode utf8 code string with preferred
    ...
    def test_auto_dtype_largeint(self):
        # Regression code for numpy/numpy#5635 whereby large integers could
...
def test_gzip_loadtxt():
    ...
    # of the code reference array, write it to a securely opened file,
