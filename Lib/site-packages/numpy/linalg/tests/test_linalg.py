...
class LinalgCase(object):
    def __init__(self, name, a, b, tags=set()):
        """
        A bundle of arguments to be passed to a code case, with an identifying
    ...
    def check(self, do):
        """
        Run the function `do` on this code case, expanding arguments
        """
...
class TestSolve(SolveCases):
    ...
    def test_0_size_k(self):
        # code zero multiple equation (K=0) case.
        class ArraySubclass(np.ndarray):
            pass
...
class _TestNorm2D(_TestNormBase):
    ...
    def test_matrix_3x3(self):
        # This code has been added because the 2x2 example
...
class TestNorm_NonSystematic(object):
    ...
    def test_longdouble_norm(self):
        # Non-regression code: p-norm of longdouble would previously raise
        # UnboundLocalError.
        x = np.arange(10, dtype=np.longdouble)
        old_assert_almost_equal(norm(x, ord=3), 12.65, decimal=2)

    def test_intmin(self):
        # Non-regression code: p-norm of signed integer would previously do
...
class TestQR(object):
    ...
    def check_qr(self, a):
        # This code expects the argument `a` to be an ndarray or
    ...
    def test_mode_raw(self):
        ...
        # of the functions in lapack_lite. Consequently, this code is
...
def test_sdot_bug_8577():
    # Regression code that loading certain other libraries does not
...
class TestMultiDot(object):
    ...
    def test_basic_function_with_three_arguments(self):
        ...
        # determine the optimal order. Therefore code it separately.
    ...
    def test_dynamic_programming_logic(self):
        ...
        # This code is directly taken from Cormen page 376.
